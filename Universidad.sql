...
-- Ej4
select p1.apellido2,p1.apellido1,p1.nombre from persona p1 inner join profesor p2 on p2.id_profesor = p1.id where timestampdiff(year,p1.fecha_nacimiento,CURDATE());